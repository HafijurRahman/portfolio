/**
 * Portfolio Application - All Components
 * Consolidated file for proper Babel Standalone loading
 */

console.log('portfolio.js: Starting to load...');
console.log('portfolio.js: React available?', typeof React !== 'undefined');
console.log('portfolio.js: CONFIG available?', typeof CONFIG !== 'undefined');

// Make React hooks available
const { useState, useEffect, useRef } = React;

console.log('portfolio.js: React hooks destructured successfully');
...
console.log('portfolio.js: About to initialize app...');

try {
    console.log('portfolio.js: Creating React root...');
    const root = ReactDOM.createRoot(document.getElementById('root'));
    console.log('portfolio.js: Rendering App component...');
    root.render(<App />);
    console.log('portfolio.js: App rendered successfully!');
} catch (error) {
